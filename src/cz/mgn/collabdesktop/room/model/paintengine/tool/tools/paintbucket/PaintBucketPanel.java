 ...
 */
package cz.mgn.collabdesktop.room.model.paintengine.tool.tools.paintbucket;
...
public class PaintBucketPanel extends JPanel implements ChangeListener, ActionListener {
    ...
    protected PaintBucketOptions options;
    protected JSlider tolerance;
    protected JTextField toleranceValue;

    public PaintBucketPanel(PaintBucketOptions options) {
    ...
    public void stateChanged(ChangeEvent e) {
        if (e.getSource() == tolerance) {
            ...
            options.setTolerance(tolerance.getValue());
        }
    }
