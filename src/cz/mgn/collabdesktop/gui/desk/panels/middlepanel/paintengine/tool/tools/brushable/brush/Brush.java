 ...
 */
package cz.mgn.collabdesktop.gui.desk.panels.middlepanel.paintengine.tool.tools.brushable.brush;
...
public class Brush {
    ...
    protected void generateBrushCursor() {
        brushCursor = GraphicsUtil.generateOutline(paintImageNoColor, Color.BLACK, false);
    }
    ...
    protected void generatePaintImage() {
        ...
        ImageProcessor.paintAddBrush(paintImageColor, paintImageNoColor, 0, 0, color.getRGB());
    }
