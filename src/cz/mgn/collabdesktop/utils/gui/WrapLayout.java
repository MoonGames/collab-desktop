...
public class WrapLayout extends FlowLayout {
     ...
     * indicated horizontal and vertical gaps. <p> The value of the alignment
     ...
     *
     * @param dim update the width and height when appropriate @param rowWidth
     * the width of the row to add @param rowHeight the height of the row to add
     */
